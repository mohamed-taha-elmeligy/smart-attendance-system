...
CREATE TABLE IF NOT EXISTS lecture (
    -- Primary Key
    lecture_id UUID DEFAULT RANDOM_UUID() PRIMARY KEY,
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_lecture_course_id ON lecture(course_id);
CREATE INDEX IF NOT EXISTS idx_lecture_instructor_id ON lecture(instructor_academic_member_id);
CREATE INDEX IF NOT EXISTS idx_lecture_date ON lecture(lecture_date);
CREATE INDEX IF NOT EXISTS idx_lecture_day_of_week ON lecture(day_of_week);
CREATE INDEX IF NOT EXISTS idx_lecture_status ON lecture(status);
CREATE INDEX IF NOT EXISTS idx_lecture_soft_delete ON lecture(soft_delete);
CREATE INDEX IF NOT EXISTS idx_lecture_room ON lecture(room);
