...
CREATE TABLE IF NOT EXISTS course_instructor (
    -- Primary Key
    course_instructor_id UUID DEFAULT RANDOM_UUID() PRIMARY KEY,
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_course_instructor_academic_member_id ON course_instructor(instructor_academic_member_id);
CREATE INDEX IF NOT EXISTS idx_course_instructor_course_id ON course_instructor(course_id);
