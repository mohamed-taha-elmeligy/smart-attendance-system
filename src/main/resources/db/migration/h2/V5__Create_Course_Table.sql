...
CREATE TABLE IF NOT EXISTS course (
    -- Primary Key
    course_id UUID DEFAULT RANDOM_UUID() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_course_university_id ON course(university_id);
CREATE INDEX IF NOT EXISTS idx_course_academic_year_id ON course(academic_year_id);
CREATE INDEX IF NOT EXISTS idx_course_soft_delete ON course(soft_delete);
