...
CREATE INDEX idx_attendance_device_id ON academic_member(device_id);
CREATE INDEX idx_attendance_qr_code_id ON attendance(qr_code_id);
CREATE INDEX idx_attendance_student_id ON attendance(student_academic_member_id);
...
CREATE INDEX idx_attendance_location_verified ON attendance(location_verified);
CREATE INDEX idx_attendance_ip_address ON attendance(ip_address);
