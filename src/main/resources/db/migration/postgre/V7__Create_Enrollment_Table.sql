...
CREATE INDEX idx_enrollment_student_academic_member ON enrollment(student_academic_member);
CREATE INDEX idx_enrollment_soft_delete ON enrollment(soft_delete) WHERE soft_delete = FALSE;
